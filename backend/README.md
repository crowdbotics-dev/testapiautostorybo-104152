...
## Project Structure
    ...
    ├── testapiautostorybo_104152  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_104152`
...
2. Clone this repo and `cd testapiautostorybo_104152`
